...
from dataloaders.mmwhs_dataset import (BaseDataSets, RandomGenerator,
...
parser.add_argument('--root_path', type=str,
                    default='../data/MMWHS_ROI', help='Name of Experiment')
parser.add_argument('--exp', type=str,
                    default='MMWHS_ROI/Uncertainty_Aware_Mean_Teacher', help='experiment_name')
...
def train(args, snapshot_path):
    ...
    max_iterations = int(args.max_iterations * (24 / batch_size))
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            if "fcn" in args.model:
                volume_batch = volume_batch.repeat_interleave(3, dim=1)
